...
export default function EditClientScreen() {
  ...
  }, [validate, clientId, name, email, phone, company, address, city, state, zip, notes, updateClient, router]);
      ...
      >
        ...
        >
          ...
          <View style={styles.actions}>
            <Button title="Save Changes" onPress={handleSave} size="lg" testID="save-edit-client" />
          </View>
        </ScrollView>
      </KeyboardAvoidingView>
    </>
